...
"use strict";
var d,e,g,h,i,
u=document.baseURI.charAt(document.baseURI.length-1)=="/"?document.baseURI.substr(0,document.baseURI.length-1):document.baseURI,c=u.substr(u.lastIndexOf("/"),u.length)+"/js/layer/", //组件存放目录，为空表示自动获取(不用填写host，相对站点的根目录即可)。
