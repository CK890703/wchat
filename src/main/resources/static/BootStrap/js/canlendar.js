...
(function (t, e) {
    ...
    function r(n, r, c) {
      ...
      z()
        ...
        function S() {
            le = r.contentHeight ? r.contentHeight : r.height ? r.height - (re ? re.height() : 0) - R(ae) : Math.round(ae.width() / Math.max(r.aspectRatio, 0.5))
        }
        function T() {
            le === e && S(),
      he++,
    ...
    r.droppable && t(document).bind('dragstart', function (e, n) {
        var a = e.target,
      o = t(a);
      ...
      l = Ee.sourceFetchers;
        ...
        y()
          ...
          b = X(r.endParam, n.endParam);
            w && (p[w] = Math.round(+E / 1000)),
          b && (p[b] = Math.round(+S / 1000)),
          m(),
          t.ajax(t.extend({
      }, Te, r, {
          data: p,
...
function p(t, n) {
    return 'object' == typeof t ? t : 'number' == typeof t ? new Date(1000 * t) : 'string' == typeof t ? t.match(/^\d+(\.\d+)?$/) ? new Date(1000 * parseFloat(t)) : (n === e && (n = !0), m(t, n) || (t ? new Date(t) : null)) : null
}
function m(t, e) {
    ...
    if (e || !n[13]) {
      ...
      n[12] && r.setMilliseconds(1000 * Number('0.' + n[12])),
      c(r, a)
    } else if (r.setUTCFullYear(n[1], n[3] ? n[3] - 1 : 0, n[5] || 1), r.setUTCHours(n[7] || 0, n[8] || 0, n[10] || 0, n[12] ? 1000 * Number('0.' + n[12]) : 0), n[14]) {
        var o = 60 * Number(n[16]) + (n[18] ? Number(n[18]) : 0);
        o *= '-' == n[15] ? 1 : -1,
      r = new Date(+r + 1000 * 60 * o)
    }
    return r
}
function y(t) {
...
function D(t) {
    ...
    n.setMonth(0),
    n.setDate(1),
    Math.floor(Math.round((e - n) / 86400000) / 7) + 1
}
function C(t) {
...
function E(n, r, a) {
    n.unbind('mouseover').mouseover(function (n) {
      ...
      l = l.parentNode;
        (i = o._fci) !== e && (o._fci = e, s = r[i], a(s.event, s.element, s), t(n.target).trigger(n)),
      n.stopPropagation()
    })
}
function S(e, n, r) {
...
function Z(e, n, r) {
    ...
    ae = new ye(function (e, n) {
      ...
      o[1] = a + r.outerWidth(),
      I.each(function (n, i) {
          ee > n && (r = t(i), a = r.offset().top, n && (o[1] = a), o = [
          a
        ], e[n] = o)
      }),
      o[1] = a + r.outerHeight()
...
Y(n.addClass('fc-agenda')),
    Oe = new ye(function (e, n) {
      ...
      i[1] = o + a.outerWidth(),
      Ue('allDaySlot') && (a = ve, o = a.offset().top, e[0] = [
        o,
        o + a.outerHeight()
      ]);
        for (var s = ge.offset().top, l = he.offset().top, c = l + he.outerHeight(), u = 0; Ae * Ne > u; u++) e.push([r(s + ze * u),
      r(s + ze * (u + 1))])
    }),
    Le = new we(Oe),
...
function te() {
      ...
      p = W();
        e.draggable({
          ...
          u.start(function (n, a) {
              ...
              p = P(0, n.col);
                  i = h(p, u),
              n.row ? s ? c && (e.width(f - 10), T(e, v * Math.round((t.end ? (t.end - t.start) / Re : y('defaultEventMinutes')) / g)), e.draggable('option', 'grid', [
                f,
                1
              ]), c = !1) : o = !0 : (Q(l(d(t.start), i), l(C(t), i)), r()),
              o = o || c && !i
              } else r(),
            o = !0;
    ...
    function g(t, e, n) {
        function r() {
            K(),
        s && (f ? (n.hide(), e.draggable('option', 'grid', null), Q(l(d(t.start), b), l(C(t), b))) : (a(D), n.css('display', ''), e.draggable('option', 'grid', [
          T,
          x
        ])))
        }
...
function re(t) {
    ...
    a,
    o;
    for (e = 0; t.length > e; e++) for (n = t[e], r = 0; n.length > r; r++) for (a = n[r], a.forwardSegs = [
    ], o = e + 1; t.length > o; o++) se(a, t[o], a.forwardSegs)
}
function ae(t) {
    var n,
    r,
...
var e,
      ...
      r = t.length;
for (e = 0; r > e; e++) n = t[e],
      j[n._id] ? j[n._id].push(n) : j[n._id] = [
        n
      ]
}
function v() {
...
function p(t, e) {
    J.push({
      ...
      I[t._id] ? I[t._id].push(e) : I[t._id] = [
        e
      ]
}
function m() {
...
function C(t, e, n, r, a, o, s) {
    var l = e.allDay,
      c = e._id;
    E(j[c], n, r, a),
      i('eventDrop', t, e, n, r, a, function () {
          E(j[c], -n, -r, l),
        B(c)
      }, o, s),
      B(c)
...
function M(t, e, n, r, a, o) {
    var s = e._id;
    S(j[s], n, r),
      i('eventResize', t, e, n, r, function () {
          S(j[s], -n, -r),
        B(s)
      }, a, o),
      B(s)
...
function E(t, n, r, a) {
    r = r || 0;
    for (var o, i = t.length, s = 0; i > s; s++) o = t[s],
      a !== e && (o.allDay = a),
      u(l(o.start, n, !0), r),
...
function S(t, e, n) {
    n = n || 0;
    for (var r, a = t.length, o = 0; a > o; o++) r = t[o],
      r.end = u(l(g(r), e, !0), n),
      Y(r, V)
}
function T(t) {
...
function L(t, e) {
    for (var n = _.getRowCnt(), r = _.getColCnt(), a = [
      ], o = W(t), i = W(e), s = A(o), l = A(i) - 1, c = 0; n > c; c++) {
        var u = c * r,
        f = u + r - 1,
        d = Math.max(s, u),
        v = Math.min(l, f);
...
function de() {
    ...
    function p(t) {
        for (var e = [
      ], n = m(t), r = 0; n.length > r; r++) e.push.apply(e, n[r]);
        return e
    }
    function m(t) {
        t.sort(ge);
