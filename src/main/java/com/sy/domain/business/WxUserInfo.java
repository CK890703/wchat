 ...
 * 关注用户
 */
public class WxUserInfo extends WxErrMsg {
    /**
     * 主键
     */
    private Integer id;
    ...
    //用户关注时间(Date)
    private String subscribeTimeDate;
    ...
    public String getSubscribeTimeDate() {
        return subscribeTimeDate;
    }

    public void setSubscribeTimeDate(String subscribeTimeDate) {
